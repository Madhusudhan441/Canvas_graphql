  ...
  import { profileUpdate } from '../actions/ProfileUpdate';
  import ProfileReducer from '../reducers/ProfileReducer' 
import { getProfile } from '../../src/components/queries/query';
import {withApollo} from 'react-apollo';
  ...
  let stufac = localStorage.getItem('stufac')
  ...
  await this.props.profileUpdate(stufac,loginid,name,email,phonenumber,about,city,country,company,hometown,language,school,gender)
  // setTimeout(() => {
    let count = 0
  ...
  // console.log("heh",this.props.response)
  // }, 5000);
...
this.setState({
  ...
  // export default connect(mapStateToProps, { profileUpdate })(ProfileMain);
export default withApollo(ProfileMain);
